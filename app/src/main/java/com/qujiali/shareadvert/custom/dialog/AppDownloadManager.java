...
import com.qujiali.shareadvert.module.other.view.AndroidOPermissionActivity;
...
public class AppDownloadManager {
    ...
    public void downloadApk(String apkUrl, String title, String desc) {
        ...
        request.setDestinationInExternalFilesDir(weakReference.get(), Environment.DIRECTORY_DOWNLOADS, "广告圈.apk");
...
//                            ToastUtils.shortToast(context, "授权失败，无法安装应用");
                           CommonUtil.INSTANCE.showToast(context,"授权失败，无法安装应用");
                        }
                    };
        ...
        if (completeDownLoadId == mReqId) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) { // 6.0以下
                ...
                uri = FileProvider.getUriForFile(context,
                        "com.qujiali.jiaogegongren",
                        new File(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "xiangzhe.apk"));
