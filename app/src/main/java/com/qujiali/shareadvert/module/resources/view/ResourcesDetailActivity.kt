...
import kotlinx.android.synthetic.main.activity_home_detail.home_type1
import kotlinx.android.synthetic.main.activity_home_detail.home_type2
import kotlinx.android.synthetic.main.activity_home_detail.home_type3
import kotlinx.android.synthetic.main.activity_home_detail.home_type4
...
import kotlinx.android.synthetic.main.activity_home_detail.tv_call_number as tv_call_number1
import kotlinx.android.synthetic.main.activity_resources.tv_look_number as tv_look_number1

class ResourcesDetailActivity : BaseLifeCycleActivity<ResourcesViewModel>() {
    ...
    override fun initView() {
        ...
        mViewModel.loadResourcesSingleData(mResourcesId!!)
        initRecycler()
    ...
    override fun initDataObserver() {
        ...
        mViewModel.onQueryBanner.observe(this, Observer {
            it?.let {
                ...
                mViewModel.loadResourcesLookPhone(mResourcesId!!)
            }
        })
    }
            ...
            override fun OnCreateViewHolder(
                ...
                return object : ViewHolder<String?>(parent, R.layout.item_settlein_image) {
                    ...
                    override fun setData(data: String?) {
                        super.setData(data)
                        Glide.with(this@ResourcesDetailActivity).load(data).into(iv_image!!);
                    }
                }
            }
        }
    ...
    private fun setData(it: BaseResponse<ResourcesResponse>) {
        ...
        tvHomeCity.text = "服务区域：${it.data.areaList?.joinToString("")}"
    ...
    private fun showCaptchaDialog(url: String) {
        ...
        mSwipeCaptchaView.setOnCaptchaMatchCallback(object :
            ...
            override fun matchFailed(swipeCaptchaView: SwipeCaptchaView) {
                CommonUtil.showToast(this@ResourcesDetailActivity, "验证失败")
