...
class PublishResourcesActivity : BaseLifeCycleActivity<ResourcesViewModel>() {
    ...
    override fun getLayoutId(): Int = R.layout.activity_rublish_resources
...
//        toolbarTextViewRight.text = "发布规则"
    ...
    override fun initDataObserver() {
        ...
        mViewModel.uploadFiles.observe(this, androidx.lifecycle.Observer {
            it.let {
    ...
    private fun sendData() {
        if (TextUtils.isEmpty(tvResourceTitle.text.toString())) {
            CommonUtil.showToast(this, "请输入资源标题")
            return
        }
        ...
        if (TextUtils.isEmpty(
            ...
            TextUtils.isEmpty(
                ...
                et_company_skill4.text.toString().trim { it <= ' ' }
            )
        ) {
            CommonUtil.showToast(this, "请输入关键字")
            return
        }
        ...
        mMap["img"] =  CommonUtil.listToString(mImageList)!!
        mMap["area"] = adCode!!
                            ...
                            .setCompressListener(object : OnCompressListener {
                                ...
                                override fun onSuccess(file: File) {
                                    try {
                                        ...
                                        mViewModel.uploadFiles(mPathList)
